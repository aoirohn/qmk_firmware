...
[_QWERTY] = LAYOUT( \
      ...
      ADJUST, KC_CAPS, KC_LALT, KC_LGUI, LT(_LOWER,KC_LANG2), KC_SPC, KC_BSPC, KC_ENT,  KC_SPC,  LT(_RAISE,KC_LANG1), KC_RGUI, KC_RALT, KC_APP,  CTL_T(KC_ESC) \
      ),
  /* Colemak
   * ,-----------------------------------------.             ,-----------------------------------------.
  ...
  [_EUCALYN] = LAYOUT( \
      ...
      CTL_T(KC_ESC), KC_A,   KC_O,    KC_E,    KC_I,    KC_U,                      KC_G,    KC_T,    KC_K,    KC_S,    KC_N,    KC_QUOT, \
  ...
  [_QWERTY_W] = LAYOUT( \
      ...
      CTL_T(KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT, \
      KC_LSFT,       KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                     KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT , \
      ADJUST, KC_CAPS, KC_LGUI, KC_LALT, LT(_LOWER,KC_MHEN), KC_SPC, KC_BSPC, KC_ENT,  KC_SPC,  LT(_RAISE,KC_HENK), KC_RALT, KC_RGUI, KC_APP,  CTL_T(KC_ESC) \
      ),
  /* Colemak
   * ,-----------------------------------------.             ,-----------------------------------------.
   * | Tab  |   Q  |   W  |   F  |   P  |   G  |             |   J  |   L  |   U  |   Y  |   ;  | Bksp |
  ...
  [_LOWER] = LAYOUT( \
      ...
      KC_F1  , KC_F2,   KC_F3,   KC_F4,   KC_LCBR, KC_LBRC,                   KC_RBRC, KC_RCBR, KC_UP,   _______, KC_MPRV, KC_MNXT, \
      KC_F5  , KC_F6,   KC_F7,   KC_F8,   KC_F9 ,  KC_F10,                    _______, KC_LEFT, KC_DOWN, KC_UP,   KC_MUTE, KC_MPLY, \
      _______, KC_F11 , KC_F12,  _______, _______, _______, KC_DEL , KC_TAB , _______, _______, _______, _______, _______, KC_INS \
      ),
  ...
  [_RAISE] = LAYOUT( \
      ...
      KC_F1  , KC_F2,   KC_F3,   KC_F4,   KC_UNDS, KC_MINS,                   KC_EQL,  KC_PLUS, KC_PGDN, KC_PGUP, KC_VOLD, KC_VOLU, \
      KC_F5  , KC_F6,   KC_F7,   KC_F8,   KC_F9 ,  KC_F10,                    _______, _______, KC_HOME, KC_END,  KC_MUTE, KC_MPLY, \
      _______, KC_F11 , KC_F12,  _______, _______, _______, KC_DEL , KC_TAB , _______, _______, _______, _______, _______, KC_BRK \
      ),
   ...
   */
  [_ADJUST] =  LAYOUT( \
      _______, RESET,   _______, _______, _______, _______,                   _______, QWERTY_W, EUCALYN_W, COLEMAK_W, DVORAK_W, _______, \
      _______, AU_ON,   AU_OFF,  MU_TOG,  MU_MOD,  _______,                   _______, QWERTY,  EUCALYN, COLEMAK, DVORAK, _______, \
...
float tone_euralyn[][2] = SONG(COLEMAK_SOUND);

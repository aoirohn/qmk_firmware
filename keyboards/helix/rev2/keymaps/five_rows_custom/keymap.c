...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      CTL_T(KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_RCTL, \
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_GRV, KC_QUOT,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
      MO(_LOWER),MO(_LOWER),  KC_CAPS, KC_LALT, KC_LGUI, SFT_T(KC_SPC), LT(_RAISE,KC_BSPC), \
                                                         LT(_RAISE,KC_ENT), SFT_T(KC_SPC),  KC_RGUI, KC_RALT, KC_APP,MO(_LOWER),MO(_LOWER) \
      ),
  ...
  [_COLEMAK] = LAYOUT( \
      ...
      CTL_T(KC_ESC), KC_A,    KC_R,    KC_S,    KC_T,    KC_D,                      KC_H,    KC_N,    KC_E,    KC_I,    KC_O,    KC_RCTL, \
  ...
  [_DVORAK] = LAYOUT( \
      ...
      CTL_T(KC_ESC), KC_A,    KC_O,    KC_E,    KC_U,    KC_I,                      KC_D,    KC_H,    KC_T,    KC_N,    KC_S,    KC_RCTL, \
  ...
  [_EUCALYN] = LAYOUT( \
      ...
      CTL_T(KC_ESC), KC_A,    KC_O,    KC_E,    KC_I,    KC_U,                      KC_G,    KC_T,    KC_K,    KC_S,    KC_N,    KC_RCTL, \
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      RGB_HUI, RGB_SAI, RGB_VAI,RGB_RMOD,  AU_OFF, AG_NORM,                   AG_NORM,  AU_OFF,RGB_RMOD, RGB_VAI, RGB_SAI, RGB_HUI, \
